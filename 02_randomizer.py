...
chosenTeam = raw_input("Choose your team: ") #User chooses the team from which they want a random member of

if KREWES.has_key(chosenTeam):
    print (KREWES[chosenTeam][random.randint(0, len(KREWES[chosenTeam]))]) #Uses the chosenTeam key to access the associated value. Then uses a random number as an index to ultimately get a random member of the team.
else:
    print ("KREWES doesn't have team " + chosenTeam) #For when the user inputs an invalid input
